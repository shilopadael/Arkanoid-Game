...
<img src="./level1.png" width="400" height="400">
<img src="./level2.png" width="400" height="400">
...
<ol>
  ...
  <li><h4>Executable Jar File</h4> Download the release jar and double click on it (make sure you have JDK installed)</li>
  <li><h4>Opening Project From IDE</h4> Download the source code and open the project from the IDE and rebuild it.</li>
</ol>
